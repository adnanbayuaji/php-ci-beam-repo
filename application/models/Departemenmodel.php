<?php
    ...
    class Departemenmodel extends CI_Model
    {
        ...
        function tambah()
        {
            ...
            $this->db->insert('beam_ms_departemen', $data);
        }
        ...
        function tampil()
        {
            ...
            $tampil = $this->db->get('beam_ms_departemen');
        ...
        {
            //mengambil data dari tabel database ke variabel 
            $tampil = $this->db->get_where('beam_ms_departemen', array('dept_status' => 'Aktif'));
        ...
        function hapuson($id)
        {
            ...
            $this->db->update('beam_ms_departemen', $data);
        }
        ...
        {
            //membaca dari tabel
            return $this->db->get_where('beam_ms_departemen', array('dept_id'=>$id))->row();
        }
