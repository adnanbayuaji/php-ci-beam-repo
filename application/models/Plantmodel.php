<?php
    ...
    class Plantmodel extends CI_Model
    {
        ...
        function tambah()
        {
            ...
            $this->db->insert('beam_ms_plant', $data);
        }
        ...
        function tampil()
        {
            ...
            $tampil = $this->db->get('beam_ms_plant');
        ...
        {
            //mengambil data dari tabel database ke variabel 
            $tampil = $this->db->get_where('beam_ms_plant', array('pla_status' => 'Aktif'));
        ...
        function hapuson($id)
        {
            ...
            $this->db->update('beam_ms_plant', $data);
        }
        ...
        {
            //membaca dari tabel
            return $this->db->get_where('beam_ms_plant', array('pla_id'=>$id))->row();
        }
