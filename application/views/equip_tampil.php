      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'pdfqrcode'; ?>" class="btn btn-success btn-sm"><i class="fa fa-print"></i>&nbsp;Cetak Kode QR</a>&nbsp;
            <?php if($akses->men_insert == '1'){ ?>
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#impor-data">
              Impor Data
            </button> &nbsp;
            <a href="<?php echo base_url().'equip/tambah'; ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            <?php } ?>
          </div>
        </div>
        <div class="box-body">
              ...
              <table id="example2" class="table table-striped">
                <thead>
                  <tr>
                      ...
                      <th>Kode</th>
                      <th>Status Data</th>
                      <?php if($akses->men_update == '1' || $akses->men_delete == '1' || $akses->men_access == '1' ){ ?>
                      <th>Aksi</th>
                      <?php } ?>
                  </tr>
                </thead>
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <td> <?php echo $data->equ_nama; ?> </td>
                            <td> <?php echo $data->are_nama; ?> </td>
                            <td> <?php echo $data->deq_lokasi; ?> </td>
                            <td> <?php echo $data->dept_nama; ?> </td>
                            <td> <?php echo $data->deq_kode; ?> </td>
                            <td> <?php echo $data->deq_status; ?> </td>
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' || $akses->men_access == '1' ){ ?>
                            <td> 
                            <a href='<?php echo base_url()."equip/detail/".$data->deq_id; ?>'><i class="fa fa-list-ul"></i></a> &nbsp; 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."equip/update/".$data->deq_id; ?>'><i class="fa fa-edit"></i></a> &nbsp;<?php } ?> 
                            <?php if($akses->men_delete == '1' ){ 
                              if($data->deq_status == 'Aktif') {
                              ?>
                              <a href='<?php echo base_url()."equip/deleteon/".$data->deq_id; ?>' class='tombol-hapuson'><i class="fa fa-toggle-on"></i></a>
                            <?php } if($data->deq_status == 'Tidak Aktif'){?>
                              <a href='<?php echo base_url()."equip/deleteoff/".$data->deq_id; ?>' class='tombol-hapusoff'><i class="fa fa-toggle-off"></i></a>
                            <?php
                            }
                            } ?>
                            </td>
...
<div class="modal fade" id="impor-data">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
        echo form_open('equip/import', 'enctype="multipart/form-data"');
      ?>
      <div class="modal-body">
        <div class="form-group">
          <label class="control-label">Format</label>
          <label class="control-label">Silahkan unduh format template terlebih dahulu, </label> <a href='<?php echo base_url()."equip/ekspor"; ?>'><b>klik disini.</b></a>
        </div>
        <div class="form-group">
