  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'peralatan') { ?> <li class="active"><a href="<?php echo base_url().'equip'; ?>"><i class="fa fa-cube"></i> <span>Peralatan </span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="box box-info">
        ...
        <?php
            echo form_open('equip/update/'.$hasil->deq_id, 'class="form-horizontal"');
        ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                ...
                // echo form_dropdown('dept', $options, '', $extra);
                // echo form_error('status');
                // $role = array('name'=>'role', 'maxlength'=>'254','value'=>$hasil->rol_id, 'class'=>'form-control');
                // echo form_input($role);
                
                echo form_dropdown('equid', $equid, $hasil->equ_id, array('class' => 'form-control select2'));
                echo form_error('equid');
              ?>     
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Lokasi Pabrik</label>
            <div class="col-sm-10">
              <?php
                
                echo form_dropdown('plant', $plant, $hasil->pla_id, array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <?php
                // $status = array('name'=>'status', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                // echo form_input($status);
                // $dept = array('name'=>'dept', 'maxlength'=>'254','value'=>$hasil->dept_id, 'class'=>'form-control');
                // echo form_input($dept);
                echo form_dropdown('area', $area, $hasil->are_id, array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $lokasi = array('name'=>'lokasi', 'maxlength'=>'254','value'=>$hasil->deq_lokasi, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <?php
                ...
                // $dept = array('name'=>'dept', 'maxlength'=>'254','value'=>$hasil->dept_id, 'class'=>'form-control');
                // echo form_input($dept);
                echo form_dropdown('dept', $dept, $hasil->dept_id, array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $jenis = array('name'=>'jenis', 'maxlength'=>'254','value'=>$hasil->deq_jenis, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $kapasitas = array('name'=>'kapasitas', 'maxlength'=>'254','value'=>$hasil->deq_kapasitas, 'class'=>'form-control');
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" title="Kode Alat harus unik dan tidak terdapat dalam database!">Kode*</label>
            <div class="col-sm-10">
              <?php
                $kode = array('name'=>'kode', 'maxlength'=>'254','value'=>$hasil->deq_kode, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $merk = array('name'=>'merk', 'maxlength'=>'254','value'=>$hasil->deq_merk, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $model = array('name'=>'model', 'maxlength'=>'254','value'=>$hasil->deq_model, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $noasset = array('name'=>'noasset', 'maxlength'=>'254','value'=>$hasil->deq_noasset, 'class'=>'form-control');
                echo form_input($noasset);
                echo form_error('noasset');
              ?>     
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Pengecekan</label>
            <div class="col-sm-10">
              <div class="input-group date">
                ...
                <?php
                  $date = new DateTime($hasil->deq_tglcek);
                  $tglcekstring = $date->format('m/d/Y');
                  $tglcek = array('name'=>'tglcek', 'maxlength'=>'100','value'=>$tglcekstring, 'class'=>'form-control', 'id'=>'datepicker');
                  echo form_input($tglcek);
                ?>    
              </div> 
              <?php 
                echo form_error('tglcek');
              ?>
            </div>
          </div>
        </div>
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'equip'; ?>" class="btn btn-default">Kembali</a> &nbsp;
            <?php 
