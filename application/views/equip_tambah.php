...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('equip/tambah', 'class="form-horizontal"');
      ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                ...
                // $role = array('name'=>'role', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                // echo form_input($role);
                echo form_dropdown('equid', $equid, array(), array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_dropdown('plant', $plant, array(), array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <?php
                ...
                // $dept = array('name'=>'dept', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                // echo form_input($dept);
                echo form_dropdown('area', $area, array(), array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $lokasi = array('name'=>'lokasi', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <?php
                ...
                // $dept = array('name'=>'dept', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                // echo form_input($dept);
                echo form_dropdown('dept', $dept, array(), array('class' => 'form-control select2'));
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $kapasitas = array('name'=>'kapasitas', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $kode = array('name'=>'kode', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $merk = array('name'=>'merk', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $model = array('name'=>'model', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $noasset = array('name'=>'noasset', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                echo form_input($noasset);
                echo form_error('noasset');
              ?>     
              <p class="help-block">Isikan "<b>-</b>" jika bukan termasuk asset.</p>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group date">
                ...
                <?php
                  $tglcek = array('name'=>'tglcek', 'maxlength'=>'100','value'=>"", 'class'=>'form-control', 'id'=>'datepicker', 'autocomplete'=>'off');
