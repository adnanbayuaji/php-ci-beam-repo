...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('itemcheck/update/'.$hasil->ite_id, 'class="form-horizontal"');
      ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $obyek = array('name'=>'obyek', 'maxlength'=>'254','value'=>$hasil->ite_obyek, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $standar = array('name'=>'standar', 'maxlength'=>'254','value'=>$hasil->ite_standar, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $metode = array('name'=>'metode', 'maxlength'=>'254','value'=>$hasil->ite_metode, 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $alat = array('name'=>'alat', 'maxlength'=>'254','value'=>$hasil->ite_alat, 'class'=>'form-control');
