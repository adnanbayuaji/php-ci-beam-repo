      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->equ_nama, 'nama');
              ?>     
            </div>
          </div>
          <br/>
                        ...
                        <?php
                            ...
                            if(!empty($dtl_poin))
                            {
                                foreach($dtl_poin as $data)
                                {
                                    ...
                                    <td> <?php echo $data->dpo_standar_min; ?> </td>
                                    <td> <?php echo $data->dpo_standar_max; ?> </td>
                                    </tr>
                                    <?php
                                    $no++;
                                }
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'typeequip'; ?>" class="btn btn-default btn-sm">Kembali</a>
          </div>
        </div>
      </div>
    </section>
