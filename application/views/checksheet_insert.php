...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <?php
        echo form_open('checksheet/insert', 'class="form-horizontal" enctype="multipart/form-data" id="frm-insert"');
      ?>
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
              echo form_hidden('hidden_deqid', $hasil->deq_id);
              echo form_hidden('hidden_equid', $hasil->equ_id);
              $attributes = array(
                'class' => 'form-control'
                );
                echo form_label($hasil->equ_nama." ".$hasil->are_nama." ".$hasil->deq_lokasi, 'alat', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
                        ...
                        <?php
                            ...
                            if(!empty($dtl_poin))
                            {
                                foreach($dtl_poin as $data)
                                {
                                    ...
                                    <?php 
                                      $angka = array('name'=>'angka'.$data->dpo_id, 'maxlength'=>'254','value'=>'', 'class'=>'form-control', 'required'=>true, 'onkeypress'=>'return hanyaAngka(event)');
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'checksheet'; ?>" class="btn btn-default">Kembali</a> &nbsp;
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    tinymce.remove();
    tinymce.init({
        selector: "textarea#txtKeterangan",
        width:      '100%',
        height:     270,
        plugins:    [ "anchor link" ],
        statusbar:  false,
        menubar:    false,
        toolbar:    "undo bold italic underline styleselect fontselect | alignleft aligncenter alignright alignjustify",
