      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="<?php echo base_url().'area/tambah'; ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            <?php } ?>
          </div>
        </div>
        <div class="box-body">
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <td> <?php echo $data->are_status; ?> </td>
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
                            <td> 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."area/update/".$data->are_id; ?>'><i class="fa fa-edit"></i></a>&nbsp;<?php } ?> 
                            <?php if($akses->men_delete == '1' ){ 
                              if($data->are_status == 'Aktif') {
                              ?>
                              <a href='<?php echo base_url()."area/deleteon/".$data->are_id; ?>' class='tombol-hapuson'><i class="fa fa-toggle-on"></i></a>
                            <?php } if($data->are_status == 'Tidak Aktif'){?>
                              <a href='<?php echo base_url()."area/deleteoff/".$data->are_id; ?>' class='tombol-hapusoff'><i class="fa fa-toggle-off"></i></a>
                            <?php
                            }
                            } ?>
                            </td>
...
<div class="modal fade" id="impor-data">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
        echo form_open('area/import', 'enctype="multipart/form-data"');
      ?>
      <div class="modal-body">
        <div class="form-group">
          <label class="control-label">Format</label>
          <label class="control-label">Silahkan unduh format template terlebih dahulu, </label> <a href='<?php echo base_url()."area/ekspor"; ?>'><b>klik disini.</b></a>
        </div>
        <div class="form-group">
