  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="<?php echo base_url().'area'; ?>"><i class="fa fa-globe"></i> <span>Area </span></a></li> 
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
                            <td> 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."user/update/".$data->usr_id; ?>'><i class="fa fa-edit"></i></a> &nbsp;<?php } ?>
