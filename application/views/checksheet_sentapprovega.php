...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'sentapprovega') { ?> <li class="active"><a href="<?php echo base_url().'checksheet/sentapprovega'; ?>"><i class="fa fa-list-alt"></i> <span>Persetujuan oleh PIC GA </span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-info-circle"></i> Daftar Persetujuan
      ...
      <!-- info row -->
      <?php
        echo form_open('checksheet/sentapprovega', 'class="form-horizontal" id="frm-example"');
      ?>
      <div class="col-md-12">
                      ...
                      if(!empty($approvega))
                      {
                          foreach($approvega as $data)
                          {
                              ...
                              <?php 
                                ...
                                echo " ";
                                $dataw = array(
                                  'class' => 'btn btn-success btn-xs catatan',
                                  'type' => 'button',
                                  'id' => $data->tch_id,
        ...
        <div class="col-xs-12">
          ...
          <?php 
              $data = array(
                ...
                'type' => 'button',
                'data-toggle' => 'modal',
                'data-target' => '#impor-data',
                'content' => '<i class="fa fa-times"></i> Tolak'
              );
              ...
              $datar = array(
                ...
                'type' => 'submit',
                'id' => 'submit',
                'content' => '<i class="fa fa-check-square-o"></i> Setuju',
...
<div class="modal fade" id="impor-data">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
        echo form_open('checksheet/tolakdataga', 'enctype="multipart/form-data" id="frm-tolak"');
      ?>
      <div class="modal-body">
        <div class="form-group">
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      // Start jQuery click function to view Bootstrap modal when view info button is clicked
      $('#example').on('click', '.catatan', function(){
      // Get the id of selected phone and assign it in a variable called phoneData
        var tchData = $(this).attr('id');
        // Start AJAX function
        $.ajax({
          // Path for controller function which fetches selected phone data
          url: "<?php echo base_url() ?>Checksheet/setCatatan",
          // Method of getting data
          method: "POST",
          // Data is sent to the server
          data: {tchData:tchData},
