...
<head>
  ...
  <title>BEAM | Item Pemeriksaan</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'itempemeriksaan') { ?> <li class="active"><a href="<?php echo base_url().'itemcheck'; ?>"><i class="fa fa-list-alt"></i> <span>Item Pemeriksaan </span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Item Pemeriksaan</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('itemcheck/tambah', 'class="form-horizontal"');
      ?>
        <div class="box-body">
          <div class="form-group">
            <label class="col-sm-2 control-label">Obyek</label>
            <div class="col-sm-10">
              <?php
                $obyek = array('name'=>'obyek', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                echo form_input($obyek);
                echo form_error('obyek');
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $standar = array('name'=>'standar', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                echo form_input($standar);
                echo form_error('standar');
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $metode = array('name'=>'metode', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                echo form_input($metode);
                echo form_error('metode');
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $alat = array('name'=>'alat', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                echo form_input($alat);
                echo form_error('alat');
              ?>     
            </div>
          </div>
        </div>
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'itemcheck'; ?>" class="btn btn-default">Kembali</a> &nbsp;
            <?php 
...
<script>
  $('input[name=21]').change(function () {
    if ($(this).prop('checked')) {
      ...
      $('input[name=101]').prop('checked', true);
    } else {
      ...
      $('input[name=101]').prop('checked', false);
    }
  });
  $('input[name=21]').trigger('change');
  $('input[name=22]').change(function () {
    if ($(this).prop('checked')) {
      ...
      $('input[name=102]').prop('checked', true);
    } else {
      ...
      $('input[name=102]').prop('checked', false);
    }
  });
  $('input[name=22]').trigger('change');
  $('input[name=23]').change(function () {
    if ($(this).prop('checked')) {
      ...
      $('input[name=103]').prop('checked', true);
    } else {
      ...
      $('input[name=103]').prop('checked', false);
    }
  });
  $('input[name=23]').trigger('change');
  $('input[name=24]').change(function () {
    if ($(this).prop('checked')) {
      ...
      $('input[name=104]').prop('checked', true);
    } else {
      ...
      $('input[name=104]').prop('checked', false);
    }
  });
  $('input[name=24]').trigger('change');
  $('input[name=25]').change(function () {
    if ($(this).prop('checked')) {
      ...
      $('input[name=105]').prop('checked', false);
    }
  });
  $('input[name=25]').trigger('change');
  $('input[name=111]').change(function () {
    if ($(this).prop('checked')) {
  ...
  $('input[name=111]').trigger('change');
  $('input[name=112]').change(function () {
    if ($(this).prop('checked')) {
  ...
  $('input[name=112]').trigger('change');
  $('input[name=113]').change(function () {
    if ($(this).prop('checked')) {
  ...
  $('input[name=113]').trigger('change');
  $('input[name=114]').change(function () {
    if ($(this).prop('checked')) {
  ...
  $('input[name=114]').trigger('change');
  $('input[name=115]').change(function () {
    if ($(this).prop('checked')) {
      $('input[name=125]').prop('checked', true);
      $('input[name=135]').prop('checked', true);
    } else {
      $('input[name=125]').prop('checked', false);
      $('input[name=135]').prop('checked', false);
    }
  });
  $('input[name=115]').trigger('change');
