...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('user/ubahprofil/'.$hasil->usr_id, 'class="form-horizontal" enctype="multipart/form-data"');
      ?>
        <div class="box-body">
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                $npk = array('name'=>'npk', 'maxlength'=>'15','value'=>$hasil->usr_npk, 'class'=>'form-control', 'onkeypress'=>'return hanyaAngka(event)');
                echo form_input($npk);
                echo form_error('npk');
              ?>     
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                ...
                echo form_dropdown('status', $options, $hasil->usr_status, $extra);
