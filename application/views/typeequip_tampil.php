      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="<?php echo base_url().'typeequip/tambah'; ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            <?php } ?>
          </div>
        </div>
        <div class="box-body">
          <div class="form-group">
            <div style="overflow: auto">
              <table id="example2" class="table table-striped table-expandable">
                <thead>
                  <tr>
                      <th>NO</th>
                      <th>Nama</th>
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <td> <?php echo $data->equ_status; ?> </td>
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' || $akses->men_access == '1' ){ ?>
                            <td> 
                            <a href='<?php echo base_url()."typeequip/detail/".$data->equ_id; ?>'><i class="fa fa-list-ul"></i></a> &nbsp; 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."typeequip/update/".$data->equ_id; ?>'><i class="fa fa-edit"></i></a> &nbsp;<?php } ?>
                            <?php if($akses->men_delete == '1' ){ 
                              if($data->equ_status == 'Aktif') {
                              ?>
                              <a href='<?php echo base_url()."typeequip/deleteon/".$data->equ_id; ?>' class='tombol-hapuson'><i class="fa fa-toggle-on"></i></a>
                            <?php } if($data->equ_status == 'Tidak Aktif'){?>
                              <a href='<?php echo base_url()."typeequip/deleteoff/".$data->equ_id; ?>' class='tombol-hapusoff'><i class="fa fa-toggle-off"></i></a>
                            <?php
                            }
                            } ?>
                            </td>
