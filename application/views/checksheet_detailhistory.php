    ...
    <section class="content container-fluid">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Detail Daftar Riwayat Pemeriksaan</h3>
        </div>
        <div class="box-body">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label">Tanggal Checksheet</label>
            <div class="col-sm-10">
              <?php
              $attributes = array(
                'class' => 'form-control'
                );
                echo form_label($tch->tch_tanggal, 'tgl', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              $attributes = array(
                ...
                echo form_label($tch->usr_namalengkap." (".$tch->usr_npk.")", 'karyawan', $attributes);
              ?>     
            </div>
          </div>
          <br/>
                        ...
                        <?php
                            ...
                            if(!empty($poin))
                            {
                                foreach($poin as $data)
                                {
                                    ...
                                    <td> <?php echo $data->tdp_nilai; ?> &nbsp; <?php echo $data->dpo_satuan; ?>
                                    </td>
                                    </tr>
                                    <?php
                                    $no++;
                          ...
                          <?php
                            ...
                            if(!empty($item))
                            {
                              foreach($item as $data)
                              {
                                ?>
                                <tr>
                                <td><?php echo $data->ite_obyek; ?></td><td
                                ><?php
                                if($data->tdi_kondisi == '1') echo 'OK';
                                else if($data->tdi_kondisi == '2') echo 'Repaired';
                                else if($data->tdi_kondisi == '3') echo 'Broken';
                                ?>
                                </td></tr>
                                <?php
                                $no++;
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'checksheet/history/'.$hasil->equ_id."/".$hasil->deq_id; ?>" class="btn btn-default">Kembali</a> &nbsp;
          </div>
        </div>
      </div>
    </section>
