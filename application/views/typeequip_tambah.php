...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('typeequip/tambah', 'class="form-horizontal" id="frm-example"');
      ?>
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                ...
                echo form_dropdown('berkala', $options, '', $extra);
                    ...
                    <?php
                        ...
                        if(!empty($dtl_poin))
                        {
                            foreach($dtl_poin as $data)
                            {
                                ...
                                <td> <a data-toggle="modal" data-target="#modal_edit_poin<?php echo $data->id;?>"><i class="fa fa-edit"></i></a> &nbsp;
                                <a href='<?php echo base_url()."typeequip/delete_poin/".$data->id; ?>' class='tombol-hapus'><i class="fa fa-trash-o"></i></a>
                                </tr>
                                <?php
                                $no++;
                            }
          ...
          <div class="col-lg-6">
            <div class="panel box box-secondary">
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-striped display dataTable dt-checkboxes-select">
                    <thead>
                      <tr>
                        <th></th>
...
<div class="modal fade" id="modal-poin">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
          echo form_open('typeequip/tambah_poin');
      ?>
      <div class="modal-body">
        <div class="form-group">
...
if(!empty($dtl_poin))
{
  ...
  {
  ?>
<div class="modal fade" id="modal_edit_poin<?php echo $data->id;?>">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <?php
          echo form_open('typeequip/update_poin/'.$data->id);
      ?>
      <div class="modal-body">
        <div class="form-group">
          <label class="control-label">Nama Pemeriksaan</label>
