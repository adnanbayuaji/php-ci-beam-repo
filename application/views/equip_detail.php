      ...
      ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              $attributes = array(
                ...
                echo form_label($hasil->equ_nama, 'equip', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->are_nama, 'area', $attributes);
              ?>  
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_lokasi, 'lokasi', $attributes);
              ?>     
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_jenis, 'jenis', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_kapasitas, 'kapasitas', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_merk, 'merk', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_model, 'model', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                echo form_label($hasil->deq_noasset, 'noasset', $attributes);
              ?>     
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Tanggal Pengecekan</label>
            <div class="col-sm-10">
              <div class="input-group date">
                ...
                <?php
                  echo form_label($hasil->deq_tglcek, 'tanggal', $attributes);
                ?>    
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php if(file_exists(FCPATH.'temp/'.$hasil->deq_kode.'.png')){?>
                  <img src="<?php echo base_url().'temp/'.$hasil->deq_kode.'.png'; ?>"/>
                <?php }?>
            </div>
          </div>
        </div>
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <?php if(!file_exists(FCPATH.'temp/'.$hasil->deq_kode.'.png')){?>
              <a href="<?php echo base_url().'equip/generateqr/'.$hasil->deq_id; ?>" class="btn btn-primary btn-sm"><i class="fa fa-qrcode"></i>&nbsp;Generate QR Code</a>
            <?php }?>
            <a href="<?php echo base_url().'equip'; ?>" class="btn btn-default btn-sm">Kembali</a>
          </div>
        </div>
        <!-- /.box-footer -->
      </div>
