    ...
    <section class="content container-fluid">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'user/reset/'.$hasil->usr_id; ?>" class="btn btn-primary btn-sm">Reset Kata Sandi</a>
          </div>
        </div>
      <?php
      ...
      ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php
                ...
                echo form_dropdown('role', $role, $hasil->rol_id, array('class' => 'form-control select2'));
        ...
        <div class="box-footer">
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'user'; ?>" class="btn btn-default">Kembali</a> &nbsp;
            <?php 
