  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'departemen') { ?> <li class="active"><a href="<?php echo base_url().'departemen'; ?>"><i class="fa fa-location-arrow"></i> <span>Departemen </span></a></li> 
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
              <table id="example2" class="table table-striped table-hover table-expandable">
              <?php } else { ?>
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
                            <td> 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."departemen/update/".$data->dept_id; ?>'><i class="fa fa-edit"></i></a> &nbsp;<?php } ?> 
