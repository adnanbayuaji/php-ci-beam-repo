...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('area/update/'.$hasil->are_id, 'class="form-horizontal"');
      ?>
        <!-- <form action="<?php echo base_url().'area/update/'.$hasil->are_id; ?>" method="POST" class="form-horizontal"> -->
        <div class="box-body">
          <div class="form-group">
            <label class="col-sm-2 control-label">Nama</label>
            <div class="col-sm-10">
            <!-- <input type="text" name="nama" maxlength="30" value="<?php echo $hasil->are_nama; ?>" size="30" class="form-control"/> -->
            
            <?php
                $nama = array('name'=>'nama', 'maxlength'=>'30','value'=>$hasil->are_nama,'size'=>'30', 'class'=>'form-control');
