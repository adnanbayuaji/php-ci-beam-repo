...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <?php
          echo form_open('plant/update/'.$hasil->pla_id, 'class="form-horizontal"');
      ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <?php
                $nama = array('name'=>'nama', 'maxlength'=>'30','value'=>$hasil->pla_nama,'size'=>'30', 'class'=>'form-control');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <?php
                $kode = array('name'=>'kode', 'maxlength'=>'30','value'=>$hasil->pla_kodearea,'size'=>'30', 'class'=>'form-control');
        ...
        <div class="box-footer">
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'plant'; ?>" class="btn btn-default">Kembali</a> &nbsp;
            <?php 
