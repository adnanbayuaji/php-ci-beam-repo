      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="<?php echo base_url().'role/tambah'; ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            <?php } ?>
          </div>
        </div>
        <div class="box-body">
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <tr>
                            <td> <?php echo $no; ?> </td>
                            <td> <?php echo $data->rol_deskripsi; ?> </td>
                            <td> <?php echo $data->rol_status; ?> </td>
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
                            <td> 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."role/update/".$data->rol_id; ?>'><i class="fa fa-edit"></i></a> &nbsp;<?php } ?>
                            <?php if($akses->men_delete == '1' ){ 
                              if($data->rol_status == 'Aktif') {
                              ?>
                              <a href='<?php echo base_url()."role/deleteon/".$data->rol_id; ?>' class='tombol-hapuson'><i class="fa fa-toggle-on"></i></a>
                            <?php } if($data->rol_status == 'Tidak Aktif'){?>
                              <a href='<?php echo base_url()."role/deleteoff/".$data->rol_id; ?>' class='tombol-hapusoff'><i class="fa fa-toggle-off"></i></a>
                            <?php
                            }
                            } ?>
                            </td>
