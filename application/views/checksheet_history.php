    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Daftar Riwayat Pemeriksaan</h3>
                  ...
                  <?php
                      ...
                      if(!empty($detail))
                      {
                          foreach($detail as $data)
                          {
                              ...
                              <td> <?php echo $data->tch_approval; ?> </td>
                              <td> <?php 
                              if($data->tch_statuscek == 'ontime')
                              { 
                                echo "<span class='label label-success'>".$data->tch_statuscek."</span>"; 
                              }
                              else 
                              {
                                echo "<span class='label label-danger'>".$data->tch_statuscek."</span>"; 
                              }
                              ?> </td>
                              <td> <a href='<?php echo base_url()."checksheet/detail_history/".$hasil->deq_id."/".$data->tch_id; ?>'><i class="fa fa-list-ul"></i></a>
                              </td></tr>
                              <?php
                              $no++;
                          }
                      ...
                      else
                      {
                          ?>
                          <tr>
                              <td colspan="8"><b>TIDAK ADA DATA</b></td>
                          </tr>
                          <?php
                      }
                  ?>
