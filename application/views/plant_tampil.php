  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'plant') { ?> <li class="active"><a href="<?php echo base_url().'plant'; ?>"><i class="fa fa-building"></i> <span>Pabrik </span></a></li> 
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="<?php echo base_url().'plant/tambah'; ?>" class="btn btn-primary btn-sm">Tambah Data</a>
            <?php } ?>
          </div>
        </div>
        <div class="box-body">
                ...
                <?php
                    ...
                    if(!empty($hasil))
                    {
                        foreach($hasil as $data)
                        {
                            ...
                            <td> <?php echo $data->pla_nama; ?> </td>
                            <td> <?php echo $data->pla_status; ?> </td>
                            <?php if($akses->men_update == '1' || $akses->men_delete == '1' ){ ?>
                            <td> 
                            <?php if($akses->men_update == '1' ){ ?><a href='<?php echo base_url()."plant/update/".$data->pla_id; ?>'><i class="fa fa-edit"></i></a>&nbsp;<?php } ?> 
                            <?php if($akses->men_delete == '1' ){ 
                              if($data->pla_status == 'Aktif') {
                              ?>
                              <a href='<?php echo base_url()."plant/deleteon/".$data->pla_id; ?>' class='tombol-hapuson'><i class="fa fa-toggle-on"></i></a>
                            <?php } if($data->pla_status == 'Tidak Aktif'){?>
                              <a href='<?php echo base_url()."plant/deleteoff/".$data->pla_id; ?>' class='tombol-hapusoff'><i class="fa fa-toggle-off"></i></a>
                            <?php
                            }
                            } ?>
                            </td>
