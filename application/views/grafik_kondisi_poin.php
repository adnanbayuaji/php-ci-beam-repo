...
<head>
  ...
  <title>BEAM | Grafik Kondisi by Poin</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Grafik Kondisi by Poin</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Grafik Kondisi by Poin</h3>
        </div>
        <div class="box-body">
...
$(document).ready(function(){
  $.post("<?php echo base_url().'graph/load_grafik_poin'; ?>", // ?awal='+awal+"&akhir="+akhir,
  function(data){
