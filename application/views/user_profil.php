      ...
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url().'user/ubahprofil/'.$hasil->usr_id; ?>" class="btn btn-info btn-sm">Ubah Profil</a> &nbsp; 
            <a href="<?php echo base_url().'user/ubahpass/'.$hasil->usr_id; ?>" class="btn btn-primary btn-sm">Ubah Kata Sandi</a>
          </div>
        </div>
        <div class="box-body">
          <div class="col-sm-3">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->rol_deskripsi, 'role', $attributes);
                    ?>     
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <?php
                      ...
                      echo form_label($hasil->pla_nama, 'plant', $attributes);
                  ?>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->usr_npk, 'npk', $attributes);                
                    ?>     
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->usr_namalengkap, 'fullnama', $attributes);                
                    ?>     
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->usr_email, 'email', $attributes);                
                    ?>     
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->usr_nama, 'nama', $attributes);                
                    ?>     
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php
                      ...
                      echo form_label($hasil->usr_status, 'status', $attributes);
                    ?>     
                  </div>
                </div>
              </div>
