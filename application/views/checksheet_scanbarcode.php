          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url().'index.php/user/profil/'.$this->session->userdata('id'); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pindai Kode QR</li>
      </ol>
    </section>
        ...
        <div class="col-md-4 col-md-offset-4">
          <div class="panel panel-danger">
            ...
            <div class="panel-footer">
                <center><a class="btn btn-danger" href="<?php echo base_url().'checksheet'; ?>">Kembali</a></center>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript" src="<?php echo base_url()."assets/qrcode/js/qrcodelib.js"; ?>"></script>
<script type="text/javascript" src="<?php echo base_url()."assets/qrcode/js/webcodecamjquery.js"; ?>"></script>
...
<script type="text/javascript">
    var arg = {
        resultFunction: function(result) {
           ...
           // $.post("../cek.php", { noijazah: result.code} );
            var redirect = '<?php echo base_url().'viewscan/showscan'; ?>';
    ...
    decoder.options.beep = '<?php echo base_url().'assets/qrcode/audio/beep.mp3'; ?>';
    decoder.options.decoderWorker = '<?php echo base_url().'assets/qrcode/js/DecoderWorker.js'; ?>';
    decoder.play();
