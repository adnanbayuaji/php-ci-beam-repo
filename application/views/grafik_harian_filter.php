  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Grafik Harian</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Grafik Harian Filter</h3>
        </div>
        <div class="box-body">
          <?php
              echo form_open('graph/harian', 'class="form-horizontal"');
          ?>
