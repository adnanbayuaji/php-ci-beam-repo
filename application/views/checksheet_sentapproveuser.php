  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } else if($datas->men_nama == 'sentapproveuser') { ?> <li class="active"><a href="<?php echo base_url().'checksheet/sentapproveuser'; ?>"><i class="fa fa-list-alt"></i> <span>Umpan Balik </span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-info-circle"></i> Umpan Balik
                            ...
                            <td> 
                              <?php 
                                ...
                                $datawr = array(
                                  ...
                                  'type' => 'button',
                                  'id' => $data->tch_id,
                                  'content' => '<i class="fa fa-comments-o"></i>'
                                );
                                echo form_button($datawr);
                              ?>
                            </td>
                            </tr>
                            <?php
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
  ...
  <script type="text/javascript">
    ...
    // Get the id of selected phone and assign it in a variable called phoneData
      ...
      // Start jQuery click function to view Bootstrap modal when view info button is clicked
      $('#example').on('click', '.feedback', function(){
      // Get the id of selected phone and assign it in a variable called phoneData
        var tchData = $(this).attr('id');
        // Start AJAX function
        $.ajax({
          // Path for controller function which fetches selected phone data
          url: "<?php echo base_url() ?>Checksheet/setFeedback",
          // Method of getting data
          method: "POST",
          // Data is sent to the server
          data: {tchData:tchData},
          ...
          success: function(data){
            // Print the fetched data of the selected phone in the section called #phone_result 
            // within the Bootstrap modal
              $('#tch_feedback').html(data);
              // Display the Bootstrap modal
              $('#feedback').modal('show');
              tinymce.remove();
              tinymce.init({
                  selector: "textarea#txtFeedback",
                  width:      '100%',
                  height:     270,
                  plugins:    [ "anchor link" ],
                  statusbar:  false,
